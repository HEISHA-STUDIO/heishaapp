...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_FLIGHT_PREPARE=225, /* Do all actions needed before flight to the charge pad. |Empty.| Empty.| Empty.| Empty.| Empty.| Empty.| Empty.|  */
   MAV_CMD_PAUSE_MISSION=226, /* Pause mission. |Empty.| Empty.| Empty.| Empty.| Empty.| Empty.| Empty.|  */
   MAV_CMD_CONTINUE_MISSION=227, /* Continue mission. |Empty.| Empty.| Empty.| Empty.| Empty.| Empty.| Empty.|  */
   MAV_CMD_ONE_KEY_TO_CHARGE=228, /* One key to charge. |Empty.| Empty.| Empty.| Empty.| Empty.| Empty.| Empty.|  */
   MAV_CMD_TAKE_PHOTO=229, /* Take a photo. |Empty.| Empty.| Empty.| Empty.| Empty.| Empty.| Empty.|  */
   MAV_CMD_PAD_LOCK=230, /* Charge pad lock. |Empty.| Empty.| Empty.| Empty.| Empty.| Empty.| Empty.|  */
   MAV_CMD_PAD_UNLOCK=231, /* Charge pad unlock. |Empty.| Empty.| Empty.| Empty.| Empty.| Empty.| Empty.|  */
   MAV_CMD_PAD_TURN_ON_RC=232, /* Charge pad turn on rc. |Empty.| Empty.| Empty.| Empty.| Empty.| Empty.| Empty.|  */
   MAV_CMD_PAD_TURN_OFF_RC=233, /* Charge pad turn off rc. |Empty.| Empty.| Empty.| Empty.| Empty.| Empty.| Empty.|  */
   MAV_CMD_PAD_TURN_ON_DRONE=234, /* Charge pad turn on drone. |Empty.| Empty.| Empty.| Empty.| Empty.| Empty.| Empty.|  */
   MAV_CMD_PAD_TURN_OFF_DRONE=235, /* Charge pad turn off drone. |Empty.| Empty.| Empty.| Empty.| Empty.| Empty.| Empty.|  */
   MAV_CMD_PAD_START_CHARGE=236, /* Charge pad start charge. |Empty.| Empty.| Empty.| Empty.| Empty.| Empty.| Empty.|  */
   MAV_CMD_PAD_STOP_CHARGE=237, /* Charge pad stop charge. |Empty.| Empty.| Empty.| Empty.| Empty.| Empty.| Empty.|  */
