...
{
    ChangePad* ChangePadGlobal = new ChangePad(qgcApp(),qgcApp()->toolbox());
    return ChangePadGlobal;
}
*/
//end
...
void QGCApplication::_initCommon(void)
{
    ...
    //davis start
  //   qmlRegisterSingletonType<ChangePad>              ("QGroundControl",                           1, 0,   "ChangePad",         qDataMgrSingletonFactory);
...
void QGCApplication::_missingParamsDisplay(void)
{
 ...
 //davis    showMessage(tr("Parameters are missing from firmware. You may be running a version of firmware QGC does not work correctly with or your firmware has a bug in it. Missing params: %1").arg(params));
    }
}
