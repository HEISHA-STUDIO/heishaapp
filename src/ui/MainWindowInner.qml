...
Item {
    ...
    signal reallyClose
    signal chargePadChooseClicked
  //  property bool _userloginshow
    ...
    //davis property var _viewList: [ settingsViewLoader, setupViewLoader, planViewLoader, flightView, analyzeViewLoader ]
    property var _viewList: [ settingsViewLoader, planViewLoader, flightView, analyzeViewLoader ]

    readonly property string _settingsViewSource:   "AppSettings.qml"
//davis      readonly property string _setupViewSource:      "SetupView.qml"
...
*/
  //  property bool _chargePadShow : 0
    ...
    function showSettingsView() {
         ...
         flightView.flightViewsetuserlogin()
...
*/
    ...
    QGCToolBarButton {
        ...
        source:           flightView.chargePadShow ?  "/res/CameraT3" : "/res/SettingT3"
        logo:               false
        ...
        onClicked:          {
           ...
           flightView.chargePadChoose()
          /*  if(_chargePadShow)
               _chargePadShow = false
            else
                _chargePadShow = true*/
                            }
...
/*    // QGCButton {
  ...
  //      id:             chargeButton
      ...
      //  anchors.bottom:  parent.bottom
        height:          ScreenTools.toolbarHeight
        width:           ScreenTools.toolbarHeight*2
        visible:        true
         opacity:        1
         z:                  QGroundControl.zOrderTopMost+1
         onDoubleClicked: {
...
//davis         onShowSetupView:        mainWindow.showSetupView()
...
*/
    ...
    FlightDisplayView {
        ...
        anchors.fill:       parent
        visible:            true
    //   onchargePadShowchange:   _chargePadShow
        //-------------------------------------------------------------------------
