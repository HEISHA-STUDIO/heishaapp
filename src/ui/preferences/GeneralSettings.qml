...
QGCView {
    ...
    property int _firstColumn:      ScreenTools.defaultFontPixelWidth * 18 //ScreenTools.defaultFontPixelWidth * 12
   ...
   //davis start
    ...
    Rectangle {
        ...
        GridLayout {
            ...
            Repeater {
                model: [ qsTr("IP"), qsTr("Port"), qsTr("ID") ]
