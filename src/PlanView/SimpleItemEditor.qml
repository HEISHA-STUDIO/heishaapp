...
/*
    ExclusiveGroup {
        id: altRadios
        onCurrentChanged: {
          //  altModeLabel.text = qsTr("Relative to home altitude") // Qt.binding(function() { return current.helpText })
            missionItem.altitudeMode = _altModeRelative //current.altModeValue
        }
    }
*/
    Column {
        ...
        Rectangle {
            ...
            Column {
                ...
                QGCLabel {
                    ...
                    anchors.right:  parent.right
                    wrapMode:       Text.WordWrap
                    text :   qsTr("Relative to home altitude")
                    font.pointSize: ScreenTools.smallFontPointSize
                }
