...
QGCView {
    ...
    QGCViewPanel {
        ...
        FlightMap {
            ...
            Repeater {
                model: _missionController.visualItems  //_editingLayer == _layerMission ? _missionController.visualItems : undefined

                delegate: MissionItemMapVisual {
                    map:        editorMap
                    qgcView:    _qgcView
                    onClicked:  _missionController.setCurrentPlanViewIndex(sequenceNumber, false)
                    visible:   true// _editingLayer == _layerMission
                }
            }

            // Add lines between waypoints
            MissionLineView {
                model: _missionController.waypointLines  //_editingLayer == _layerMission ? _missionController.waypointLines : undefined
            }
...
/*
    ...
    Component {
        ...
        Column {
            ...
            property string _overwriteText: qsTr("Mission overwrite")//(_editingLayer == _layerMission) ? qsTr("Mission overwrite") : ((_editingLayer == _layerGeoFence) ? qsTr("GeoFence overwrite") : qsTr("Rally Points overwrite"))
