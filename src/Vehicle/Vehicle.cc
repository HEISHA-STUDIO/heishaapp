...
Vehicle::Vehicle(LinkInterface*             link,
    ...
    , _telemetryRNoise(0)
    , _maxProtoVersion(0)
    , _vehicleCapabilitiesKnown(true)  //davis  false
    , _capabilityBits(0)
...
void Vehicle::_mavlinkMessageReceived(LinkInterface* link, mavlink_message_t message)
{
    ...
    case MAVLINK_MSG_ID_WIND:
        ...
        break;
#endif
     case MAVLINK_MSG_ID_CHAREGE_PAD:
        _handleChargepad(message) ;
    }
...
void Vehicle::_handleChargepad(mavlink_message_t& message)
{
    mavlink_charege_pad_t chargepad;
    mavlink_msg_charege_pad_decode(&message, &chargepad);
...
void Vehicle::_handleHeartbeat(mavlink_message_t& message)
{
  ...
  //  qWarning() << "heartbeat message" << heartbeat.system_status << endl;
...
{
    //    qWarning() << "sendMessageOnLink" << endl;
...
void Vehicle::_sendMessageOnLink(LinkInterface* link, mavlink_message_t message)
{
     ...
     //  qWarning() << "_sendMessageOnLink" << endl;
...
{
    Q_UNUSED(errorCode);
 //davis 1204   qgcApp()->showMessage(tr("Mission transfer failed. Retry transfer. Error: %1").arg(errorMsg));
}
...
{
   // qWarning()   <<   "_startPlanRequest" <<  _missionManagerInitialRequestSent  << _parameterManager->parametersReady()  <<  _vehicleCapabilitiesKnown;
...
void Vehicle::_setsystemRclinkStatus(bool systemRclinkStatus)
{
    if (_systemRclinkStatus != systemRclinkStatus) {
        _systemRclinkStatus = systemRclinkStatus;
        emit systemRclinkStatusChanged(systemRclinkStatus);
    }
}

void Vehicle::_setsystemDronelinkStatus(bool systemDronelinkStatus)
{
    if (_systemDronelinkStatus != systemDronelinkStatus) {
        _systemDronelinkStatus = systemDronelinkStatus;
        emit systemDronelinkStatusChanged(systemDronelinkStatus);
    }
}

void Vehicle::_setsystemFlyconditionStatus(bool systemFlyconditionStatus)
{
    if (_systemFlyconditionStatus != systemFlyconditionStatus) {
        _systemFlyconditionStatus = systemFlyconditionStatus;
        emit systemFlyconditionsStatusChanged(systemFlyconditionStatus);
    }
}

void Vehicle::_setsystemFlyingStatus(bool systemFlyingStatus)
{
    if (_systemFlyingStatus != systemFlyingStatus) {
        _systemFlyingStatus = systemFlyingStatus;
        emit systemFlyingStatusChanged(systemFlyingStatus);
    }
}

void Vehicle::_setsystemFlypauseStatus(bool systemFlypauseStatus)
{
    if (_systemFlypauseStatus != systemFlypauseStatus) {
        _systemFlypauseStatus = systemFlypauseStatus;
        emit systemFlypauseStatusChanged(systemFlypauseStatus);
    }
}
...
void Vehicle::flyReady(void){
    _firmwarePlugin->guidedModeFlyReady(this);
}

void Vehicle::flyPauseUse(void){
    _firmwarePlugin->guidedModePauseUse(this);
}

void Vehicle::flyContinueUse(void){
    _firmwarePlugin->guidedModeContinueUse(this);
}
