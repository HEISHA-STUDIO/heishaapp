...
public:
    ...
    Q_PROPERTY(bool systemRclinkStatus                  READ systemRclinkStatus         NOTIFY systemRclinkStatusChanged)
    Q_PROPERTY(bool systemDronelinkStatus               READ systemDronelinkStatus      NOTIFY systemDronelinkStatusChanged)
    Q_PROPERTY(bool systemFlyconditionStatus            READ systemFlyconditionStatus   NOTIFY systemFlyconditionsStatusChanged)
    Q_PROPERTY(bool systemFlyingStatus                  READ systemFlyingStatus         NOTIFY systemFlyingStatusChanged)
    Q_PROPERTY(bool systemFlypauseStatus                READ systemFlypauseStatus       NOTIFY systemFlypauseStatusChanged)
    ...
    Q_INVOKABLE void flyReady(void);
    Q_INVOKABLE void flyPauseUse(void);
     Q_INVOKABLE void flyContinueUse(void);
    ...
    bool            systemRclinkStatus                  () const { return _systemRclinkStatus; }
    bool            systemDronelinkStatus                  () const { return _systemDronelinkStatus; }
    bool            systemFlyconditionStatus                  () const { return _systemFlyconditionStatus; }
    bool            systemFlyingStatus                  () const { return _systemFlyingStatus; }
    bool            systemFlypauseStatus                  () const { return _systemFlypauseStatus; }
    ...
    void _setsystemRclinkStatus(bool systemRclinkStatus);
    void _setsystemDronelinkStatus(bool systemDronelinkStatus);
    void _setsystemFlyconditionStatus(bool systemFlyconditionStatus);
    void _setsystemFlyingStatus(bool systemFlyingStatus);
    void _setsystemFlypauseStatus(bool systemFlypauseStatus);
...
signals:
    ...
    void systemRclinkStatusChanged(bool systemRclinkStatus);
    void systemDronelinkStatusChanged(bool systemDronelinkStatus);
    void systemFlyconditionsStatusChanged(bool systemFlyconditionStatus);
    void systemFlyingStatusChanged(bool systemFlyingStatus);
    void systemFlypauseStatusChanged(bool systemFlypauseStatus);
...
private:
...
#endif
    void _handleChargepad(mavlink_message_t& message);
    ...
    bool            _flying;
    bool            _systemRclinkStatus;
    bool            _systemDronelinkStatus;
    bool            _systemFlyconditionStatus;
    bool            _systemFlyingStatus;
    bool            _systemFlypauseStatus;
